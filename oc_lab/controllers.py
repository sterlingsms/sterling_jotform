...
def get_oclab_order_data(sid):
    if sid:
        ...
        iframe_src = current_app.config['JOTFORM_EP_BASE_URL']+current_app.config['OC_REQUEST_FORM_ID']+"?PhysicianName="+physician_data['physician_name']+physician_data['degree_designation']+"&PhysicianSid="+sid+"&isIframeEmbed=1"
